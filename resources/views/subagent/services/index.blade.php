                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span>نسبة العمولة: <strong>{{ $service->pivot->custom_commission_rate ?? $service->commission_rate }}%</strong></span>
                                            <a href="{{ route('subagent.services.show', $service) }}" class="btn btn-sm btn-primary">
