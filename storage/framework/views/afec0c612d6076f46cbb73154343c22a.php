            ...
            <form action="<?php echo e(route('admin.settings.updateAdvancedSettings')); ?>" method="POST" class="mb-0">
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <h5 class="mb-3">إعدادات حسب الدور</h5>
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="role_based_settings" name="role_based_settings" value="1" <?php echo e($settings['role_based_settings'] ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="role_based_settings">
                                إعدادات حسب الدور
                                <small class="d-block text-muted">تفعيل إعدادات مختلفة حسب دور المستخدم</small>
                            </label>
                    ...
                    <div class="col-lg-6">
                        <h5 class="mb-3">سجلات التدقيق</h5>
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="audit_logs" name="audit_logs" value="1" <?php echo e($settings['audit_logs'] ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="audit_logs">
                                سجلات التدقيق
                                <small class="d-block text-muted">عرض التغييرات التي تم إجراؤها على الإعدادات</small>
                            </label>
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <h5 class="mb-3">تخصيص الثيمات</h5>
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="customizable_themes" name="customizable_themes" value="1" <?php echo e($settings['customizable_themes'] ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="customizable_themes">
                                تخصيص الثيمات
                                <small class="d-block text-muted">السماح للمسؤولين بتخصيص الثيمات</small>
                            </label>
            ...
            <form action="<?php echo e(route('admin.settings.updateFooterFeatures')); ?>" method="POST" class="mb-0">
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <h5 class="mb-3">معاينة الفوتر</h5>
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="footer_preview" name="footer_preview" value="1" <?php echo e($settings['footer_preview'] ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="footer_preview">
                                معاينة الفوتر
                                <small class="d-block text-muted">عرض معاينة حية للفوتر أثناء التعديل</small>
                            </label>
                    ...
                    <div class="col-lg-6">
                        <h5 class="mb-3">سحب وإفلات الروابط</h5>
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="drag_and_drop_links" name="drag_and_drop_links" value="1" <?php echo e($settings['drag_and_drop_links'] ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="drag_and_drop_links">
                                سحب وإفلات الروابط
                                <small class="d-block text-muted">إعادة ترتيب الروابط باستخدام السحب والإفلات</small>
                            </label>
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <h5 class="mb-3">طرق تواصل إضافية</h5>
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="additional_contact_methods" name="additional_contact_methods" value="1" <?php echo e($settings['additional_contact_methods'] ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="additional_contact_methods">
                                طرق تواصل إضافية
                                <small class="d-block text-muted">إضافة طرق تواصل مثل واتساب وتيليجرام</small>
                            </label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mohammed/web/sys.jaksws.com/public_html/resources/views/admin/settings.blade.php ENDPATH**/ ?>