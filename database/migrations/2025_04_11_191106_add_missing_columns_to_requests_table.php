...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('service_requests', 'agency_id')) {
            Schema::table('service_requests', function (Blueprint $table) {
        ...
        if (!Schema::hasColumn('service_requests', 'details')) {
            Schema::table('service_requests', function (Blueprint $table) {
        ...
        if (!Schema::hasColumn('service_requests', 'required_date')) {
            Schema::table('service_requests', function (Blueprint $table) {
        ...
        if (!Schema::hasColumn('service_requests', 'requested_date')) {
            Schema::table('service_requests', function (Blueprint $table) {
