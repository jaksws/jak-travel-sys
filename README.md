...
![إصدار النظام](https://img.shields.io/badge/الإصدار-2.0.0-blue)  
...
**RTLA** هو نظام متكامل لإدارة وكالات السفر، يتيح تنظيم العلاقات بين الوكلاء، السبوكلاء، والعملاء ضمن بيئة موحدة وآمنة. يتميز بدعم كامل للغة العربية واتجاه RTL.
...
- 📄 إدارة عروض الأسعار والموافقة عليها  
- 💸 نظام مالي لإدارة العمولات والمدفوعات  
- 🗃️ أرشفة المستندات وإدارة الصلاحيات  
- 🌐 دعم متعدد اللغات  
- 🌙 الوضع الليلي/المظلم  
- 💳 دعم بوابات الدفع (مدى، فيزا، Apple Pay...)
...
### 🧑‍💼 السبوكيل
- استعراض الخدمات والطلبات
- تقديم العروض ومتابعة حالة الطلبات
- متابعة المستحقات والدفعات

### 🙋 العميل
- تقديم الطلبات المختلفة
- استلام العروض وتتبع حالة الطلب حتى التنفيذ
...
- رفع وربط الملفات بالطلبات والمستخدمين  
- تنظيم داخل مجلدات  
- صلاحيات مشاهدة حسب نوع المستخدم
